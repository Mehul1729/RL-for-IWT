...
class IowaEnv:
    ...
    All rewards and penalties are now STOCHASTIC (variable) to
    ...
    def __init__(self, episode_length: int = 100):
        ...
        self._deck_properties = {
            ...
            # --- NEW "EXTREME" TRAP DECKS ---
            # "THE SIREN": Highest *immediate* reward, but net zero. Very attractive trap.
            # Deck G: EV per 10: (10 * 125) - (2.5 * 500) = 1250 - 1250 = 0 (Net Zero)
            6: {'reward': [120, 125, 130], 'penalty_amount': [-450, -500, -550], 'penalty_prob': 0.25},
            
            # "THE GRIN": Variable outcomes that average to a *slight* loss. Very hard to detect.
    ...
    def _calculate_reward(self, action: int) -> int:
        ...
        # Select a random reward from the deck's reward list
